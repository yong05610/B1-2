...
## AuraBlanc (오라블랑) 당신의 숨결이 향기가 되는 순간 ( 치약 브랜드 )
...
* **편집 도구 사용 범위:** 일반 모델(gemini, GPT)와 gemini 동영상 외에 특별한 편집도구는 사용하지 않았음.
* **크레딧(비용) 관리 전략:** 특별한 전략 없었음.
* **대체 도구(플랜 B) 준비:** 학습 네이토에서 동영상이 불완전 해서 gemini 무료버젼의 동영상 사용 
